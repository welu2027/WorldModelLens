...
from world_model_lens.core import LatentTrajectory, LatentState
...
class EpisodeCollector:
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "gymnasium is not installed. Install it with: "
    ...
    def collect_dataset(
        ...
        for ep_idx in episode_range:
            ...
            states = []
            for t in range(len(episode.observations) - 1):  # -1 because we have obs at each step + final obs
